...
<!-- Použitá písma -->
<xsl:param name="body.font.family" select="'Arial,serif'"/>
<xsl:param name="title.font.family" select="'Arial,serif'"/>
...
<!-- na začátku budeme vypisovat obsah, seznamy obrázků, tabulek -->
...
<xsl:template match="para">
    <fo:block hyphenate="false" line-height="1.5" xsl:use-attribute-sets="normal.para.spacing">
      <xsl:apply-templates/>
    </fo:block>
</xsl:template>
...
<!-- Pridanie line breakov prazdnym blockom -->
