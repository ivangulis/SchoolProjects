...
public class Main extends Application {
	...
	public void renameMainWindow() {
		...
		mwc.getLabelPrint().setText(language.getString(""));
		...
		mwc.getLabelAllChamps().setText(language.getString("MainWindowAllChamps"));
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			LOG.info("Client properties were successfully loaded.");
