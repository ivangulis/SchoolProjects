...
/**
 * Mapped champion entity in database.
 * Attributes: name, role, winRatio, playRatio, banRatio, released, rpCost, ipCost
 * @author Ivan Gulis
 */
@Entity
@Table(name="champion")
@NamedQueries({
	...
	@NamedQuery(name="Champion.getTopBans",
	query="SELECT champion FROM Champion champion ORDER BY champion.banRatio DESC")
})
